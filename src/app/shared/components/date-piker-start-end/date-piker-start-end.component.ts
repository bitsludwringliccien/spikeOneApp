    ...
    <ion-row>
      <ion-col size="5">
        <div class="start">
          ...
          <ion-datetime [value]="start" display-format="DD/MM/YYYY" cancel-text="Cancelar" done-text="Aceptar"
            [(ngModel)]="start">
          </ion-datetime>
        </div>
      </ion-col>
      <ion-col size="5">
        <div class="end">
          ...
          <ion-datetime [value]="end" display-format="DD/MM/YYYY" cancel-text="Cancelar" done-text="Aceptar"
            [(ngModel)]="end">
          </ion-datetime>
        </div>
      </ion-col>
...
export class DatePikerStartEndComponent implements OnInit {
  ...
  ngOnInit() {
    this.start = moment().subtract(this.rango, 'd').format();
